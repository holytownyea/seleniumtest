...
public class Listener implements TestWatcher {
    ...
    public void testFailed(ExtensionContext context, Throwable cause) {
        ...
        String scrennshotName = context.getTestMethod().get().getName() +
        ...
        try {
            FileUtils.copyFile(source, new File("build/reports/tests/" + scrennshotName + ".png"));
        } catch (IOException e) {
            LOGGER.info("Exception on saving scrennshot");
            e.printStackTrace();
        }
